...
const TopFightersByEloSumFirst = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:5000/api/fighters/active/sortedByEloPerMatchFirst") // Use the new endpoint
      .then((response) => {
    ...
    <div className="bg-gray-900 min-h-screen flex flex-col ">
      <main className="flex-grow mt-6 mb-12">
        <h2 className="text-xl md:text-3xl font-semibold text-center mt-4 mb-8 text-white">
          Top Fighters (Based on their First 5 Match ELO Points)
        </h2>
...
export default TopFightersByEloSumFirst;
